...
class InsertanythingLoader:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "nunchakuFlux_flux_path": ("STRING", {"default": "/path/to/svdq-int4-flux.1-fill-dev"}),
                ...
                "lora_path": ("STRING", {"default": "/path/to/lora-for-nunchaku"}),
    ...
    def load_models(self, nunchakuFlux_flux_path, fill_model_path, redux_model_path, lora_path, dtype):

        transformer = NunchakuFluxTransformer2dModel.from_pretrained(nunchakuFlux_flux_path)
        ...
        redux_pipe.enable_model_cpu_offload()
